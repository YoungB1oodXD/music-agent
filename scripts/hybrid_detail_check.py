...
output = []
output.append('Detailed hybrid results:')
...
with open('E:/Workspace/music_agent/.sisyphus/tmp/hybrid_detail.txt', 'w', encoding='utf-8') as f:
    f.write('\n'.join(output))

print('Written to .sisyphus/tmp/hybrid_detail.txt')